...
print("\033[1;95m[2] \033[1;92mยิงเบอร์รั่ววๆ")
print("\033[1;95m[3] \033[1;92mยิงอีเมล์")
print("\033[1;95m[4] \033[1;92mรอเเก้ฟั่งชั่นแหกเกอร์")
print("\033[1;95m[00] \033[1;92mฟัง่ชั่นนี้ใช้ไม่ได้ออก")
print("")
print("\033[1;91m[*] By:Thanakrit Yafaขอบคุณทีมาซื้อ Time: 7/11/2021")
print("")
